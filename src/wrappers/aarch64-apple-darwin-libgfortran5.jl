# Autogenerated wrapper script for CompilerSupportLibraries_jll for aarch64-apple-darwin-libgfortran5
export libatomic, libgcc_a, libgcc_s, libgfortran, libgomp, libssp, libstdcxx
...
function __init__()
    ...
    JLLWrappers.@init_file_product(
        libgcc_a,
        "lib/gcc/aarch64-apple-darwin/15/libgcc.a",
    )
