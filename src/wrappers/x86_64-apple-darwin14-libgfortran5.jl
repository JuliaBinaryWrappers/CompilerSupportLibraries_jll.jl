# Autogenerated wrapper script for CompilerSupportLibraries_jll for x86_64-apple-darwin14-libgfortran5
...
const libgfortran_splitpath = ["lib", "libgfortran.5.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libgfortran = "/workspace/destdir/x86_64-apple-darwin14/lib/libgfortran.5.dylib"
