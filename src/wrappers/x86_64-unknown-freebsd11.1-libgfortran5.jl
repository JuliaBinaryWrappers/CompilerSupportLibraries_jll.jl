# Autogenerated wrapper script for CompilerSupportLibraries_jll for x86_64-unknown-freebsd11.1-libgfortran5
...
const libgfortran_splitpath = ["lib", "libgfortran.so.5"]
